...
def render_bm_cli_guidance() -> str:
    ...
    lines = [
        ...
        '    multiple generated files -> batch-write with a short manifest body',
        '    inspect markdown structure -> outline <path>',
        '    inspect exact local context -> read-range <path> <start:end>',
        '    exact markdown section edit -> replace-section <path> "<heading>" with body',
        '    ai-authored markdown section edit -> rewrite-section <path> "<heading>" with a short goal body',
