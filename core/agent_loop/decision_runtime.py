...
in decision_work_plan, decision_task_bind, decision_replies,
decision_resume, and decision_meeting_invite.
"""
...
from core.agent_loop.decision_meeting_invite import (
    _record_meeting_invite_accept,
    _record_meeting_invite_decline,
)
...
def apply_decision(
    ...
    if decision.decision == "decline":
        _record_meeting_invite_decline(agent, trigger, decision, result)
    ...
    if decision.commitmentKind == "meeting":
        _record_meeting_invite_accept(agent, trigger)
