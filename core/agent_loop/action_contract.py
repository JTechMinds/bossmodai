...
def default_action_contract_template() -> str:
    ...
    lines = [
        ...
        "  - cli + batch-write: require data.body as a short manifest with path + goal entries, not full file contents",
        '  - cli + replace-section: require data.body as the literal new section body; quote headings with spaces in data.cmd',
        '  - cli + rewrite-section: require data.body as a short rewrite goal; quote headings with spaces in data.cmd',
