...
NotificationKind = Literal["receipt", "completion", "blocked", "handoff", "abandoned", "task_update", "host_path_consent", "cli_approval", "queue_visibility"]
...
class NotificationLink(BaseModel):
    ...
    notification_id: str
    target_kind: Literal["desk", "host_path_consent", "cli_approval"] = "desk"
    target_path: str
