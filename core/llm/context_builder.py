"""BossMod AI — Live LLM context assembly.

Settings contract/prompt preview lives in context_preview.
"""
...
def __getattr__(name: str):
    """Re-export Settings preview helpers without importing them at module load."""
    if name in {"preview_runtime_contract", "preview_prompt_bundle"}:
        from core.llm import context_preview

        return getattr(context_preview, name)
